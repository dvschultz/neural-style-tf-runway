...
class NeuralStyle():
  ...
  def parse_args():
    ...
    # normalize weights
    # arguments.style_layer_weights   = normalize(args.style_layer_weights)
    # arguments.content_layer_weights = normalize(args.content_layer_weights)
    # arguments.style_imgs_weights    = normalize(args.style_imgs_weights)
